// ==UserScript==
// @name         Khan Academy Bot V2
// @version      1.5
// @description  ur welcome cheater
// @author       Oney9305
// @match        https://es.khanacademy.org/*
// @grant        none
// ==/UserScript==
...
let item, question;
            ...
            if (!window.loaded) {
                console.clear();
                console.log("%c Answer Revealer ", "color: blue; -webkit-text-stroke: .5px black; font-size:40px; font-weight:bolder; padding: .2rem;");
                console.log("%cCreated by Oney9305 ", "color: green; -webkit-text-stroke: .5px black; font-size:15px; font-weight:bold;");
                window.loaded = true;
            }
